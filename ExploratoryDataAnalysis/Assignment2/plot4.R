...
extractCoalSCC <- function(data) {
    ...
    indexes <- do.call("c", sapply(fields, function(x) grep("coal", ignore.case = T, data[,x])))
...
a <- a + geom_line()
ggsave(file="plot4.png", width=6.0, height=3.0)
print(a)
